...
test.describe('Double Payer - Multiple Person - With Discount, Tax & Service Charge', () => {
  ...
  test('should display event on home page and show correct details', async ({
    ...
    // Verify total expense is displayed (240000 - 15000 + 5000 + 10% tax = 253000)
    // Format: Rp 253.000 (Indonesian format)
    await expect(page.getByText(/Rp\s*253[.,]000/i)).toBeVisible();
